                    ...
                    {selectedLesson ? (
                        <div className="flex w-full flex-col lg:flex-row">
                            <video
                                ...
                                className="w-full rounded-lg mx-6 lg:h-[500px]"
                            ></video>

                            {/* <img src={image.videoimg} className="w-full mx-6 lg:h-[500px]" /> */}

                            {/* Course Content */}
                            <aside className="border-l border-[#e9e9e9] lg:w-[700px]  overflow-y-scroll">
                                ...
                                <div className="flex w-full flex-col h-[500px] overflew-y-scroll">

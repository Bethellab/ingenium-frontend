...
const WhatIsIngenium = () => {
 return (
    <div className='  bg-primary rounded-xl mt-6 lg:mt-20 lg:mx-14 p-6 '>
      <div className='flex flex-col gap-6 items-center '>
        ...
        <span className="flex justify-center items-center xl:w-[900px] md:text-4xl font-medium  text-[#fff]  relative text-center ">
          ...
          organizations to attract top talent, deliver effective training
          programs, and foster a positive work environment.
        </span>
      </div>
    </div>
 )
